...
describe("ColorConverter", () => {
    ...
    describe("temperatureMiredsToKelvin", () => {
        it("should convert mireds to kelvin", () => {
            expect(ColorConverter.temperatureMiredsToKelvin(500)).toBeCloseTo(2000, 0);
            expect(ColorConverter.temperatureMiredsToKelvin(154)).toBeCloseTo(6494, 0);
        });
    });
    describe("temperatureKelvinToMireds", () => {
        it("should convert kelvin to mireds", () => {
            expect(ColorConverter.temperatureKelvinToMireds(2000)).toBeCloseTo(500, 0);
            expect(ColorConverter.temperatureKelvinToMireds(6494)).toBeCloseTo(154, 0);
        });
        it("should respect boundaries", () => {
            expect(ColorConverter.temperatureKelvinToMireds(1000, [150, 500])).toBeCloseTo(500, 0);
            expect(ColorConverter.temperatureKelvinToMireds(10000, [150, 500])).toBeCloseTo(150, 0);
        });
    });
});
