...
const homeAssistantMatcherSchema = {
    type: "object",
    default: { type: "", value: "" },
    properties: {
        type: {
...
const homeAssistantFilterSchema = {
...
const featureFlagSchema = {
    ...
    properties: {
        coverDoNotInvertPercentage: {
            ...
            description: "Mantiene el mismo porcentaje que Home Assistant para persianas/cortinas (no estándar Matter).",
            type: "boolean",
            default: false,
        },
...
const deviceIdentitySchema = {
    ...
    properties: {
        ...
        softwareVersionString: {
            ...
            description: "Opcional. Déjalo vacío para usar automáticamente la versión detectada en Home Assistant (ej: 02.07.14).",
            type: "string",
            minLength: 1,
            maxLength: 64,
        },
...
export const bridgeConfigSchema = {
    ...
    properties: {
        ...
        countryCode: {
            ...
            type: "string",
            description: "Código ISO 3166-1 alfa-2 del país donde se encuentra el nodo. Solo es necesario si el comisionado falla por falta de código de país.",
            minLength: 2,
            maxLength: 3,
        },
