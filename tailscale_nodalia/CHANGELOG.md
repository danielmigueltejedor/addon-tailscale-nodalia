...
- Add-on version: 3.11.0 → 3.12.0
- Update onboarding UI build version to 3.12.0
## 3.11.0 - 2026-08-04
### Changed
- Bump Tailscale: 1.98.10 → 1.102.1
- Add-on version: 3.10.0 → 3.11.0
- Update onboarding UI build version to 3.11.0
## 3.10.0 - 2026-07-29
### Changed
- Bump Tailscale: 1.98.9 → 1.98.10
- Add-on version: 3.9.0 → 3.10.0
- Update onboarding UI build version to 3.10.0
## 3.9.0 - 2026-07-15
### Changed
- Bump Tailscale: 1.98.8 → 1.98.9
- Add-on version: 3.8.0 → 3.9.0
- Update onboarding UI build version to 3.9.0
## 3.8.0 - 2026-06-30
### Changed
- Bump Tailscale: 1.98.4 → 1.98.8
- Add-on version: 3.7.0 → 3.8.0
- Update onboarding UI build version to 3.8.0
## 3.7.0 - 2026-05-29
### Changed
- Bump Tailscale: 1.98.3 → 1.98.4
- Add-on version: 3.6.0 → 3.7.0
- Update onboarding UI build version to 3.7.0
## 3.6.0 - 2026-05-22
### Changed
- Bump Tailscale: 1.98.2 → 1.98.3
- Add-on version: 3.5.0 → 3.6.0
- Update onboarding UI build version to 3.6.0
## 3.5.0 - 2026-05-16
### Changed
- Bump Tailscale: 1.96.4 → 1.98.2
- Add-on version: 3.4.0 → 3.5.0
- Update onboarding UI build version to 3.5.0
## 3.4.0 - 2026-05-15
### Changed
- Bump Tailscale: 1.98.1 → 1.96.4
- Add-on version: 3.3.0 → 3.4.0
- Update onboarding UI build version to 3.4.0
## 3.3.0 - 2026-05-14
### Changed
- Bump Tailscale: 1.96.4 → 1.98.1
- Add-on version: 3.2.0 → 3.3.0
- Update onboarding UI build version to 3.3.0
## 3.2.0 - 2026-03-28
### Changed
